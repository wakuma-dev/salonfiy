...
export default function Banner(){
    ...
    <div className={`w-full  ${theme === "light" ? "bg-[#f7f7f7] text-black" : "bg-[#121212] text-white"}`}>
        ...
        style={{backgroundImage: `linear-gradient(to right, rgba(92, 42, 167, 0.9), rgba(126, 96, 144, 0.75)), url(${banner})`,
            ...
            <h2 className="md:max-w-md font-bold text-[27px] leading-[32px] md:text-[44px] md:leading-[46px]">Your Next Beauty Appointment Awaits</h2>
            <p className="text-[16px] md:text-[18px] leading-[24px] md:leading-[28px] font-normal">Discover and book beauty services you'll love.</p>
